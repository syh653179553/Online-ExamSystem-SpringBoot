...
public class JudgeQuestionServiceImpl implements JudgeQuestionService {
    ...
    @Override
    public IPage<JudgeQuestion> findBySub(Page page,String subject) {
        return judgeQuestionMapper.findBySubtop(page,subject);
    }

    @Override
    public List<Integer> findBySubjectSimply(String subject, Integer pageNo) {
        return judgeQuestionMapper.findBySubjectSimply(subject,pageNo);
    }

    @Override
    public List<Integer> findBySubjectCommon(String subject, Integer pageNo) {
        return judgeQuestionMapper.findBySubjectCommon(subject,pageNo);
    }

    @Override
    public List<Integer> findBySubjectDiff(String subject, Integer pageNo) {
        return judgeQuestionMapper.findBySubjectDiff(subject,pageNo);
    }
}
